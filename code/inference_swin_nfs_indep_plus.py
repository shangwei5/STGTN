...
import time
import argparse
from model.swint_nfs_indep_plus import CDVD_TSP
...
class Inference:
    def __init__(self, args):
        ...
        self.net = CDVD_TSP(in_channels=3, n_sequence=3, out_channels=3, n_resblock=3, n_feat=32,
...
if __name__ == '__main__':
    ...
    if args.default_data == 'DVD':
        args.data_path = '/home/sw/sw/dataset/Event-data/GOPRO_large_all/test/Random'
        args.model_path = '/home/sw/sw/code/CDVD-TSP-master/experiment/bm_weight/model/model_latest.pt'
        args.result_path = '../infer_results/Random_DVD_latest_test'
    elif args.default_data == 'GOPRO':
        args.data_path = '/mnt/disk10T/shangwei/data/deblur/Random/test'
        args.model_path = '/mnt/disk10T/shangwei/code/CDVD-TSP-master/experiment/swint_nfs_indep_plus/model/model_best.pt'
        args.result_path = '../infer_results/Swint_nsf_indep_plus_shuf'
        args.n_colors = 3
        args.n_feat = 32
        args.window_size = 5
