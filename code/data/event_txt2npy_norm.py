...
def txt2npy(event_name, h=180, w=240):
    ...
    frame_index = (end_time - start_time) / 20   #0.05
    time = 1
...
#     event_path = "/media/r/sw/data/CED/train/Event/"
#     print('process event data...')
#     save_result_path = "/media/r/sw/data/CED/"
...
#         #     save_test_path1 = os.path.join('/media/r/sw/data/CED/train/Event/indoors_kitchen_2', 'event_all')
...
#         #     cv2.imwrite(os.path.join(save_test_path1, "event.png"), event)
#         #
#         #     if i == 0:
#         #         break
#         # break
