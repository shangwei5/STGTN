    ...
    def infer(self):
        with torch.no_grad():
            ...
            for v in videos:
                ...
                for in_seq, gt_seq, bm_seq, label_seq in zip(input_seqs, gt_seqs, bm_seqs, label_seqs):
                    ...
                    _, output_stage1, _, output, _ = self.net(in_tensor, bm_tensor, label_tensor)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--default_data', type=str, default='DVD',
