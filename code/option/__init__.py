...
parser.add_argument('--template', default='SWINT_HSA_NSF_REDS_finetune',
...
# Data specifications
parser.add_argument('--dir_data', type=str, default='/mnt/disk10T_2/shangwei/data/deblur/Random/train',
                    help='dataset directory')
parser.add_argument('--dir_data2', type=str, default='/mnt/disk10T_2/shangwei/data/deblur/Random/train',
                    help='dataset directory')
parser.add_argument('--dir_data_test', type=str, default='/mnt/disk10T_2/shangwei/data/deblur/Random/val',
                    help='dataset directory')
